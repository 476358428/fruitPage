	...
	var ojsonAll=[
		{
			bookId:"45123",
			bookVegetable:'蔬菜名字',
			bookVegetableHref:'123.com',
			bookVegetablePic:'img/products-co01.jpg',
			bookVegetablePrice:16.254,
			bookUser:"用户名",
			bookDate:"2014-8-14 12:24:46",
			bookQuantity:2,
			isConfirm:3,
		},
		{
	...
	function centerOrderCallback(oeach){
		var str='',
			...
			switch(parseInt(oeach.isConfirm)){
				...
				break;
				case 1:confirm="未确认";operate=btnComment+btnDelete;
				break;
