$(function(){
	...
	function addFlow(obj){
		...
		str+="<form action=\"\" class=\"product-info-buy\" name=\"product-info-buy\"><input type=\"text\" name=\"product-info-num\" class=\"product-info-num\" min=\"1\" max=\"100\" /><button name=\"product-info-submit\" class=\"product-info-submit\">加入购物车</button></form></div></div></div>";
